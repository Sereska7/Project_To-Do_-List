...
from app.crud.crud_task import task_create, get_tasks, update_task_with_permission_check, get_accessible_task
...
async def update_task(
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail=f"У пользователя нет прав на обновление задачи с id {task_id}.")
    except TaskNotFound:
